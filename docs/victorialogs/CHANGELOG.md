...
* BUGFIX: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): fix panic when executing `"_stream":=""` or `"_stream_id":=""` queries. See [#717](https://github.com/VictoriaMetrics/VictoriaLogs/issues/717). Thanks to @withlin for [the pull request](https://github.com/VictoriaMetrics/VictoriaLogs/pull/979).
